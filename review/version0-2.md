...
- [x] Update `docs/TESTING_GUIDE.md` with the new Jest unit and integration test patterns
- [x] Document workflow outcome determination and follow-up logic in `docs/WORKFLOW_EXECUTION_ANALYSIS.md`
- [x] Add an agent filtering and sorting guide section to `docs/AGENT_DEBUGGING.md`
