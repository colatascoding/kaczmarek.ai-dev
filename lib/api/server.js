    ...
    try {
      if (pathname === "/api/workflows" && method === "GET") {
        ...
        await this.agentRoutes.handleCompleteAgent(req, res, pathname);
              ...
              if (pathname.includes("/consolidate")) {
                await this.workstreamRoutes.handleConsolidateWorkstreams(req, res);
              } else if (pathname.includes("/create-from-goals")) {
                await this.workstreamRoutes.handleCreateWorkstreamsFromGoals(req, res);
              } else if (pathname.includes("/launch")) {
                await this.workstreamRoutes.handleLaunchWorkstreamAgent(req, res);
              } else if (pathname.includes("/goals")) {
                await this.workstreamRoutes.handleSetWorkstreamGoals(req, res);
              } else {
