...
3. Generate a detailed plan with:
   - Primary objectives and goals for this version
   - Success criteria
   - Key features or improvements to focus on
...
- Align with previous version's learnings`;
      ...
      return {
        ...
        cloudAgentId: result.agentId,
        status: result.status,
        message: `Planning agent launched. Monitor at: https://cursor.com/dashboard/agents/${result.agentId}`
      };
    } catch (error) {
