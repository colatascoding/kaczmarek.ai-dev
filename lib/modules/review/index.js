...
module.exports = {
  ...
  actions: {
     ...
     *
     * This is intentionally simple and non-destructive: it appends a new
     * section to the end of the existing review markdown instead of trying
     * to rewrite sections in-place. The user can then review and edit this
     * in git.
     */
